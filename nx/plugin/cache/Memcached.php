...
class Memcached extends \nx\core\Object {
    ...
    *  @param mixed $server_key    The key identifying the server to store the
    *                              value on.
    *  @access public
    *  @return bool
    */
    ...
    *
    *  @param float $token          Unique value associated with the existing
    ...
    *  @access public
    *  @return int           If the item's value is not numeric, it is treated
    *                        as if the value were 0.  If the operation would
    *                        decrease the value below 0, the new value will be
    *                        0.
    */
